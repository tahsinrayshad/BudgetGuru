...
export function EditBudgetDialog({
  ...
  useEffect(() => {
    if (isOpen) {
      ...
      setEndDate(budgetEndDate)
      setErrors({})
    }
  }, [isOpen, budgetTitle, budgetDescription, budgetAmount, budgetStartDate, budgetEndDate])
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const response = await fetch(`${window.location.origin}/api/budgets/${budgetId}`, {
        method: "PUT",
        headers: {
